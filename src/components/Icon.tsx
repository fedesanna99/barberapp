/**
 * Barberbook · Pari icon system.
 *
 * One source of truth: inline SVG glyphs, 24×24 viewBox, 1.85 stroke
 * by default. Pass `weight="fill"` for solid variants (star, heart on,
 * bookmark on, google logo). Adding a glyph = adding a key to GLYPHS.
 *
 * The hard rule from the design brief: no CDN icon font (no Phosphor,
 * Lucide, FontAwesome). All glyphs are custom Lucide-style strokes.
 */
...
export type IconName =
  ...
  | 'warning' | 'arrowRight' | 'arrowUp' | 'sun' | 'moon'

const GLYPHS: Record<IconName, ReactNode> = {
  feed: <><rect x="3" y="3" width="18" height="18" rx="2" /><line x1="3" y1="12" x2="21" y2="12" /></>,
  ...
  shop: <><path d="M3 9l1-5h16l1 5" /><path d="M5 9v11h14V9" /><path d="M9 21V14h6v7" /></>,
